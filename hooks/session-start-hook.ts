...
`;
        ...
        // Private context loading is enforced by ORCHESTRATOR.md Step 0 and
        // orchestrator-reminder.ts — no hook injection needed. The orchestrator
        // reads ${ARKADIAN_DIR}/private/CONTEXT.md on every flow (standard,
        // express, resume) which contains instructions for loading memory files.
