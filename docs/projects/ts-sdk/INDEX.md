...
|----------------|-------------|---------|---------|
| `packages/ts-sdk/` | `@arkade-os/sdk` | `0.4.30` | This SDK (wallet, providers, crypto, repositories) — npm-published path inside the tarball is unchanged |
| `packages/boltz-swap/` | `@arkade-os/boltz-swap` | `0.3.35` | Sibling Boltz Lightning/chain-swap library (docs under `docs/projects/boltz-swap/`) |
