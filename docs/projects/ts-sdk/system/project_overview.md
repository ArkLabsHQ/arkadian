...
|----------------|--------------|-------------------|------|
| `packages/ts-sdk/` | `@arkade-os/sdk` | `0.4.29` | This SDK — what the rest of this doc describes |
| `packages/boltz-swap/` | `@arkade-os/boltz-swap` | `0.3.34` | Sibling Boltz Lightning/chain-swap library; depends on `@arkade-os/sdk` via `workspace:*` (see `docs/projects/boltz-swap/`) |
