...
**Tags**: `aws-nitro`, `enclave`, `confidential-computing`, `kms`, `attestation`, `pcr0`, `pcr0-signing`, `ecdsa-p384`, `schnorr`, `bip-340`, `reproducible-build`, `nix`, `vsock`, `gvproxy`, `nitriding`, `viproxy`, `cdk`, `opentofu`, `iam`, `iam-policy`, `s3`, `aes-256-gcm`, `secrets`, `otlp`, `otlp-ingest`, `tls`, `acme`, `letsencrypt`, `tls-alpn-01`, `autocert`, `pebble`, `route53`, `route53-zone-id`, `cors`, `protocol-switching`, `h2c`, `session-manager`, `port-forwarding`, `aws-profile`, `framework`, `cli`, `cli-upgrade`, `go`, `nodejs`, `dotnet`, `rust-client`
