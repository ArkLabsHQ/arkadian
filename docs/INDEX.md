...
**Dependencies**: `@arkade-os/sdk` (0.4.38, JavaScript SDK), `@arkade-os/boltz-swap` (0.3.43), `@branta-ops/branta` (3.1.3), `@tanstack/react-virtual` (^3.13.19), `tailwindcss` (^4.2.2, with `@tailwindcss/vite`), `clsx` (^2.1.1), `tailwind-merge` (^3.5.0), `class-variance-authority` (^0.7.1), `sonner` (^2.0.7), `arkd` (server connection), `nostr-tools`. Requires **Node.js >= 24.15.0**.
