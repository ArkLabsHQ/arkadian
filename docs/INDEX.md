...
**Tags**: `aws-nitro`, `enclave`, `confidential-computing`, `kms`, `attestation`, `pcr0`, `pcr0-signing`, `ecdsa-p384`, `schnorr`, `bip-340`, `reproducible-build`, `nix`, `vsock`, `gvproxy`, `nitriding`, `viproxy`, `cdk`, `opentofu`, `iam`, `s3`, `aes-256-gcm`, `secrets`, `otlp`, `otlp-ingest`, `framework`, `cli`, `go`, `nodejs`, `dotnet`, `rust-client`
